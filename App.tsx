...
import { Plus, RefreshCw, Search, Trash2, TrendingUp, AlertCircle, Globe, Folder, ArrowLeft, FolderPlus, ExternalLink, LayoutDashboard, PenTool, Menu, X, Image as ImageIcon, Shirt, MapPin, BarChart2 } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  const renderSidebar = () => (
    <div className={`fixed inset-y-0 left-0 z-40 w-64 bg-slate-900 border-r border-slate-800 transform transition-transform duration-300 ease-in-out ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 lg:static lg:block`}>
      <div className="flex items-center gap-2 p-6 border-b border-slate-800 h-16">
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col lg:flex-row font-sans text-slate-200">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-y-auto relative">
        {/* Removed absolute menu button that was covering title */}
